...
export class Item {
    static count = 0;
    static itemList = [];
    static possibleItems = [{"itemClass": "grow", "lifeSpan": 5, "collisionEffect": effectGrowSnake},
                            {"itemClass": "shrink", "lifeSpan": 10, "collisionEffect": effectShrinkSnake},
                            {"itemClass": "death", "lifeSpan": 10, "collisionEffect": effectDead},
                            {"itemClass": "score", "lifeSpan": 10, "collisionEffect": effectScore},
                            {"itemClass": "lower-health", "lifeSpan": 10, "collisionEffect": effectDamage}];
